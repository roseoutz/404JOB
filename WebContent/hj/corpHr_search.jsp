		...
		<section id="container">
			<section class="content">
				...
				<div class="contWrap ResumeMngCont">
					...
					<div class="innerHd">
						<ul>
							<li class="hdTap"><h2 class="header"><font size="12">인재 검색</font></h2></li>
						</ul>
					</div>
					<div class="tableList  ">
						<div class="">
							...
							<ul>
								...
								<ul>
									<s:iterator value="hrSearchList" status="stat">
									<!-- [개발] 이력서 작성중 yet 클래스 추가 -->
									<li class="ing">
										...
										<div class="col col02" style="width:137px;">
											<div class="sTit" style="text-align:center;">
										...
										<div class="col col04" style="width:136px;">
											<div class="sDesc" style="text-align:center;">
										...
										<div class="col col06" style="width:136px;">
											<!-- checkbox -->
											<div class="btnCell" style="width:100px;">
												<button class="btn" type="button" style="width:70px;" onclick="javascript:location.href='corphradd.action?member_id=<s:property value="member_id"/>&cmember_id=<s:property value="%{#session['session_id']}"/>'">
													<span>관심 등록</span>
												</button>
											</div>
										</div>
