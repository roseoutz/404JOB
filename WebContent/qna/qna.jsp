					...
					<div class="tbInquiryBx">
						<div class="tbRow tbMail">
							...
							<div class="tbCell">
								...
								<input type = "hidden" name="mtm_writer" value="<s:property value="%{#session['session_id']}"/>"/>
								<input type="hidden" name = "mtm_session_type" value="<s:property value="%{#session['session_type']}"/>"/>
								<p>${type}</p>
							</div>
						</div>
						<div class="tbRow">
